        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link  <?php echo ($page == 'crpay_report')? 'active' : '' ?>" href="./?page=crpay_report">CR Pay</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <?php if($_SESSION['type'] == 0): ?>
                        ...
                        <li class="nav-item">
                        <a class="nav-link  <?php echo ($page == 'ser_sales')? 'active' : '' ?>" href="./?page=ser_sales">SS POS</a>
                        </li>
                        <li class="nav-item">
                        <a class="nav-link  <?php echo ($page == 'tps_sales')? 'active' : '' ?>" href="./?page=tps_sales">T&S POS</a>
                        </li>
                        <li class="nav-item">
                        <a class="nav-link  <?php echo ($page == 'cr_sales')? 'active' : '' ?>" href="./?page=cr_sales">CR POS</a>
                        </li> -->
