        ...
        <table class="table table-hover table-striped table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="py-0 px-1 text-center"><?php echo "<a href='javascript:void(0)' class='restock me-1' data-pid = '" . $row['product_id'] . "' data-name = '" . $row['product_code'] . ' - ' . $row['name'] . "'> <button type='button' class='btn btn-warning btn-sm'>Stock</button></a>" ?></td>
                </tr>
                <?php endwhile; ?>
